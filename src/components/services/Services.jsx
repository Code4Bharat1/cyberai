...
export default function ServicesPage() {
  ...
  const coreServices = [
    ...
    },
    {
      ...
      desc: "Install a complete AI OS in your environment that grows organically with your business.",
    ...
    },
    {
      ...
      desc: "Build bespoke LLMs and SLMs trained exclusively on your data within your environment.",
    ...
    },
    {
      ...
      desc: "Frameworks aligned with ISO 42001, GDPR, and sector-specific regulations.",
  ...
  const aiRisks = [
    ...
    },
    {
      ...
      mitigation: "Built-in governance frameworks aligned with ISO 42001, GDPR"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white mt-10">
      ...
      <section id="hero" className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-32 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-blue-200 max-w-3xl mx-auto mb-8 animate-fade-in font-light leading-relaxed">
            From strategy to deployment—comprehensive AI solutions for regulated industries
          </p>

          <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto mt-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="text-3xl font-black text-orange-400 mb-1">4-12</div>
              <div className="text-xs text-blue-100">Weeks to Deploy</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-gray-100 text-center">
              ...
              <p className="text-gray-600">
                Global enterprise AI market experiencing exponential growth across all sectors
              </p>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl p-8 text-center border-l-4 border-blue-500">
            <p className="text-gray-700 text-lg max-w-4xl mx-auto leading-relaxed">
              ...
              capabilities with the security and compliance requirements that regulated industries demand.
            </p>
          </div>
        </div>
      </section>

      {/* Service Journey - Customer Onboarding */}
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl max-w-3xl mx-auto">
              From initial consultation to production deployment in 4-12 weeks—complete AI lifecycle support
            </p>
          </div>
          ...
          <div className="relative mb-16">
            ...
            <div className="grid md:grid-cols-6 gap-4 relative z-10">
              {[
                ...
                { icon: MdArchitecture, title: "Development", desc: "Model training", time: "4-12 weeks", phase: "Phase 2" },
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-2xl p-8 text-center border-l-4 border-orange-500">
            ...
            <p className="text-gray-700 text-lg max-w-3xl mx-auto">
              <span className="font-bold text-orange-600">4-12 weeks</span> from concept to production—dramatically faster than traditional enterprise AI. Every model custom-built for your specific workflows and compliance requirements.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto animate-fade-in">
              Expert support across every dimension of enterprise AI implementation
            </p>
          </div>
      ...
      {/* Build Your Own AI OS - DETAILED SECTION */}
      <section id="ai-os" className="py-24 px-4 bg-white scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl max-w-3xl mx-auto">
              Take control—no dependency on OpenAI, Meta, or external platforms
            </p>
          </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 text-lg text-center max-w-3xl mx-auto">
              Most enterprises depend on external AI platforms. With your own AI OS, you control the entire stack—from data 
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: "Regulatory Compliance Built-In", desc: "GDPR, HIPAA, SOC 2 enforced at infrastructure level" }
                ].map((item, i) => (
      ...
      <section id="continuous-improvement" className="py-24 px-4 bg-white scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-3xl p-12 border-2 border-purple-200">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              {[
                { icon: MdArchitecture, title: "Initial Deployment", desc: "Custom model for your business", period: "Month 1" },
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-lg leading-relaxed">
                  AI models require baseline updates as the technology matures. Without continuous improvement, your models 
                  become outdated. Our maintenance includes free upgrades that keep your AI competitive throughout your 3+ year 
      ...
      {/* AI Risk Management - NEW SECTION */}
      ...
      <section id="readiness" className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl max-w-3xl mx-auto">
              Understand where you stand before committing to AI implementation
            </p>
          </div>
      ...
      {/* How We Orchestrate Enterprise AI - NEW VISUAL SECTION */}
      <section className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Visual Framework Diagram - Based on uploaded image */}
          ...
          <div className="mt-8 bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-blue-100 text-lg max-w-3xl mx-auto">
              This framework was designed from the ground up with security, governance, and close-watch regulatory 
            ...
            {[
              {
                ...
                desc: "Every service incorporates cybersecurity best practices from day one—not as an afterthought.",
                gradient: "from-orange-500 to-orange-600"
              },
              {
                icon: MdVerifiedUser,
                title: "Regulatory Expertise",
                desc: "Deep knowledge of GDPR, HIPAA, SOC 2, and industry-specific compliance requirements.",
                gradient: "from-blue-500 to-blue-600"
              },
              {
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center animate-fade-in-up">
            <div className="inline-flex items-center gap-3 bg-orange-500/20 px-6 py-3 rounded-full mb-8 border border-orange-500/30">
              ...
              <span className="text-orange-300 font-semibold">Let's Build Secure AI Together</span>
            </div>
            ...
            <p className="text-blue-200 text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
              Schedule a consultation to discuss how our services can help you achieve secure, compliant, and effective AI implementation.
            </p>
            <Link href="/contact">
